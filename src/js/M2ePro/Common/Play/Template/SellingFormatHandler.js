...
CommonPlayTemplateSellingFormatHandler.prototype = Object.extend(new CommonHandler(), {
    ...
    qty_mode_change: function()
    {
        ...
        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Template_SellingFormat::QTY_MODE_NUMBER')) {
            ...
            PlayTemplateSellingFormatHandlerObj.updateHiddenValue(this, $('qty_custom_attribute'));
        }

        $('qty_modification_mode').value = M2ePro.php.constant('Ess_M2ePro_Model_Play_Template_SellingFormat::QTY_MODIFICATION_MODE_OFF');
        ...
        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Template_SellingFormat::QTY_MODE_PRODUCT') ||
            ...
            $('qty_modification_mode').value = M2ePro.php.constant('Ess_M2ePro_Model_Play_Template_SellingFormat::QTY_MODIFICATION_MODE_ON');
    ...
    qtyPostedMode_change: function()
    {
        ...
        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Play_Template_SellingFormat::QTY_MODIFICATION_MODE_ON')) {
    ...
    price_gbr_mode_change: function()
    {
        ...
        $('price_gbr_custom_attribute').value = '';
        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Template_SellingFormat::PRICE_ATTRIBUTE')) {
            self.updateHiddenValue(this, $('price_gbr_custom_attribute'));
        }

        $('price_gbr_note').innerHTML = M2ePro.translator.translate('Product Price for selling in UK.');
    },
    ...
    price_euro_mode_change: function()
    {
        ...
        $('price_euro_custom_attribute').value = '';
        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Template_SellingFormat::PRICE_ATTRIBUTE')) {
            self.updateHiddenValue(this, $('price_euro_custom_attribute'));
        }

        $('price_euro_note').innerHTML = M2ePro.translator.translate('Product Price for selling in Europe.');
    }
