...
class Ess_M2ePro_Block_Adminhtml_Buy_Listing_ProductSearch_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    private $productId;
    ...
    public function callbackColumnTitle($value, $row, $column, $isExport)
    {
        ...
        foreach ($variations['set'] as $specificName => $specific) {
            ...
            $specificsHtml .= '<select class="specifics_'.$id.'"
                                       onchange="BuyListingProductSearchHandlerObj.specificsChange(this)"
    ...
    public function callbackColumnActions($value, $row, $column, $isExport)
    {
        ...
        if (!is_null($row->getData('variations'))) {
            $templateMapHtml = '<a href="javascript:void(0);" onclick="BuyListingProductSearchHandlerObj.mapToGeneralId('
                .$this->productId
        ...
        return '<a href="javascript:void(0);" onclick="BuyListingProductSearchHandlerObj.mapToGeneralId('
            .$this->productId
            .', \''
...
JAVASCRIPT;
    ...
    {
        return $this->getUrl('*/adminhtml_buy_listing/getSuggestedBuyComSkuGrid', array('_current'=>true));
    }
