...
class Ess_M2ePro_Block_Adminhtml_Play_Listing_Add_StepTwo extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_addButton('back', array(
            ...
            'onclick'   => 'PlayListingChannelSettingsHandlerObj.back_click(\''
                .$this->getUrl('*/adminhtml_play_listing/add',array('step'=>'1'))
                .'\')',
            'class'     => 'back'
        ));
        ...
        $this->_addButton('save_and_next', array(
            ...
            'onclick'   => 'PlayListingChannelSettingsHandlerObj.save_click(\''
