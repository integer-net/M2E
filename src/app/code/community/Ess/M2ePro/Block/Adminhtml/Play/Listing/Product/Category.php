...
class Ess_M2ePro_Block_Adminhtml_Play_Listing_Product_Category extends Mage_Adminhtml_Block_Widget_Container
{
    public function __construct()
    {
        ...
        $url = $this->getUrl(
            '*/adminhtml_play_listing/categoryProduct',
        ...
        //$url = $this->getUrl('*/adminhtml_play_listing/product',array(
        //    'id' => $listingData['id'],
        ...
        $url = $this->getUrl('*/adminhtml_play_listing/add',array('add_products'=>'yes'));
    ...
    protected function _toHtml()
    {
        ...
        $helpBlock = $this->getLayout()->createBlock('M2ePro/adminhtml_play_listing_product_category_help');
        $categoryBlock = $this->getLayout()->createBlock('M2ePro/adminhtml_play_listing_product_category_edit');
