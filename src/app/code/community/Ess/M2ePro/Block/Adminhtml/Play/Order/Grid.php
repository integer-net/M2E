...
class Ess_M2ePro_Block_Adminhtml_Play_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('reservation_state', array(
            ...
            'type'   => 'options',
            'options' => array(
                Ess_M2ePro_Model_Order_Reserve::STATE_UNKNOWN  => $helper->__('N/A'),
                Ess_M2ePro_Model_Order_Reserve::STATE_PLACED   => $helper->__('Reserved'),
                Ess_M2ePro_Model_Order_Reserve::STATE_RELEASED => $helper->__('Released'),
                Ess_M2ePro_Model_Order_Reserve::STATE_CANCELED => $helper->__('Canceled')
            )
        ));
        ...
        $this->addColumn('status', array(
            ...
            'options' => array(
                ...
                Ess_M2ePro_Model_Play_Order::STATUS_REFUNDED => $helper->__('Refunded')
            ),
