...
class Ess_M2ePro_Adminhtml_Buy_LogController extends Ess_M2ePro_Controller_Adminhtml_MainController
{
    //#############################################
    ...
    public function listingOtherGridAction()
    {
        ...
        $response = $this->loadLayout()->getLayout()
            ->createBlock('M2ePro/adminhtml_buy_listing_other_log_grid')->toHtml();
