...
class Ess_M2ePro_Block_Adminhtml_Buy_Order_Edit_ShippingAddress extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_controller = 'adminhtml_buy_order_edit';
