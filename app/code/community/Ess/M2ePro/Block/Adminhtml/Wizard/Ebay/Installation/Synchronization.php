...
class Ess_M2ePro_Block_Adminhtml_Wizard_Ebay_Installation_Synchronization extends Mage_Adminhtml_Block_Template
{
    // ########################################
    ...
    public function __construct()
    {
        ...
        //------------------------------
        $this->setId('wizardEbayInstallationSynchronization');
        //------------------------------

        $this->setTemplate('M2ePro/wizard/ebay/installation/synchronization.phtml');
    }
