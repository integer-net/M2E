...
class Ess_M2ePro_Block_Adminhtml_Play_Listing_Add_StepFourProduct extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        ...
        $this->_addButton('back', array(
            ...
            'onclick'   => 'ProductGridHandlerObj.back_click(\''
                .$this->getUrl('*/adminhtml_play_listing/add',array('step'=>'3'))
                .'\')',
            'class'     => 'back'
        ));
